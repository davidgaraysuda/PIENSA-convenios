...
import { findInvoiceByIdAndCustomer, findDetailsByInvoiceId, updateInvoice } from '../../Services/invoiceService'
import { createDetail, deleteDetail } from '../../Services/detailService'
import { getListProductAmbience, getProductById } from '../../Services/productService'
...
function InvoiceUpdate({ invoiceId }) {
  ...
  useEffect(() => {
    findInvoiceByIdAndCustomer(invoiceId)
      .then(data => {
        setInvoice(data)
      }
      )
              ...
              <TableBody>
                {details.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.ambience}</TableCell>
