...
import { findByIdCustomer } from '../../service/customerService'
    ...
    useEffect(() => {
        findContractById(invoiceId)
            .then(dataContract => {
                ...
                findByIdCustomer(dataContract.customerId)
                    .then(dataCustomer =>
        ...
        <div className="toPrinter">
            ...
            <div id="pdf">
                <div id="pdf-invoice" className="pdf__invoice">
                    ...
                    <div className="pdf__customer">
                        <p className="pdf__tittlecustomer">Contrato Cliente</p>
                        <p><span>Cliente: </span><span>{customer.name + ' ' + customer.lastname}</span></p>
                        <p><span>Fecha: </span><span>{invoice.created}</span></p>
                        <p><span>CI:: </span><span>{customer.nui}</span></p>
                        <p><span>Telf: </span><span>{customer.cellphone}</span></p>
                    </div>
                ...
                <div id="pdf-order" className="pdf__invoice">
                    ...
                    <div className="pdf__customer">
                        <p className="pdf__tittlecustomer">Orden de trabajo</p>
                        <p><span>Cliente: </span><span>{customer.name + ' ' + customer.lastname}</span></p>
                        <p><span>Fecha: </span><span>{invoice.created}</span></p>
